...
$source = 'CREATE TABLE error_logs (
...
CREATE SEQUENCE error_logs_seq;';$language = 'plsql';
...
$source = 'CREATE OR REPLACE PACKAGE dsp AS
-- --------------------------------------------------------------------------
...
$source = 'CREATE OR REPLACE PACKAGE BODY dsp AS
-- --------------------------------------------------------------------------
-- Author       : DR Timothy S Hall
-- Description  : An extension of the DBMS_OUTPUT package.
...
$source = 'CREATE OR REPLACE PACKAGE err AS
-- --------------------------------------------------------------------------
-- Author       : DR Timothy S Hall
...
$source = 'CREATE OR REPLACE PACKAGE BODY err AS
-- --------------------------------------------------------------------------
-- Author       : DR Timothy S Hall
-- Description  : A simple mechanism for logging error information to a table.
...
$source = 'execute err.line(\'This is an error\');';
$language = 'plsql';
...
$source = 'CREATE OR REPLACE PROCEDURE exception_job_proc AS
BEGIN
-- Force an error.
