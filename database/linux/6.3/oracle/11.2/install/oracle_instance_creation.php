...
<br/><br/><br/>
<h2>[Инсталляция Oracle 11.2]: Создание экземпляра базы данных (Instance)</h2>
...
<pre>
Fast Recovery Area - определить нахождение и ограничить размер области на диски, для запси резернвных копий.
...
Предлагается выбрать дополнительные компоненты. Если не предполагается их использовать, то скорее всего их следует отключить.
