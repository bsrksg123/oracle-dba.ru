...
<a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/intro.php">Введение</a><br/>
<a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/library.php">С чего начать изучение Oracle?</a><br/>
<a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/installation.php">Инсталляция базы данных Oracle</a><br/>
